...
#### Long Term Dune Growth (1D)
   1. Base Case
   2. Inclusion of Vegetation Processes
   3. Inclusion of Wet Bed Reset
   4. Inclusion of Constant Shoreline Change Rate (SCR)
...
5. Activate the newly created conda environment with the following command
   ```sh
   conda activate aeolis_course_ICCE
   ```
